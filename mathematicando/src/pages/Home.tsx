            ...
            <div className="max-w-6xl mx-auto mb-8">
                ...
                <div className="flex items-center justify-between mb-6 py-8">
                    <div>
                        ...
                        <p className="text-lg text-white/60 font-medium"> Escolha sua próxima aventura! </p>
                    </div>
                ...
                {/* Mascot Placeholder */}
                <div className="bg-gray-200/10 rounded-2xl overflow-hidden p-6 mb-8">
                    <div className="flex items-center gap-4">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="space-y-4">
                        <div className='bg-transparent flex items-center justify-end px-0 py-2 rounded-2xl mb-8'>
                            <div className='bg-gray-200/10 px-6 py-2 flex items-center rounded-full'>
